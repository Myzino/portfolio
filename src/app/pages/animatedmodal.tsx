...
export function AnimatedModalDemo() {
  ...
  const closeModal = () => {
    setIsOpen(false); // Set the state to false to close the modal
  };
  ...
  return (
    <div className="">
      <Modal>
        <ModalTrigger
          className="bg-violet-700 dark:bg-white dark:text-black text-white flex justify-center items-center px-2 py-1 text-sm rounded-md group/modal-btn"
        ...
        {/* Render ModalBody conditionally based on isOpen */}
        {isOpen && (
          <ModalBody>
            <ModalContent>

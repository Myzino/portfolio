// src/app/page.tsx or src/app/components/home.tsx (update accordingly)
...
import { AnimatedModalDemo } from "./pages/animatedmodal"; // Make sure to import if needed
                ...
                <div className="w-full md:w-2/3 p-6 flex items-center overflow-auto">
                    <div className="max-h-96 overflow-y-auto flex flex-col justify-between">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="ml-10"> {/* Add margin-left for spacing */}
                                <AnimatedModalDemo />
                            </div>
                        </div>
                    </div>
